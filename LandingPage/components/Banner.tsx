...
export default function Banner({ children, className, style }: BannerProps) {
    return (
        <div
            className={`relative flex-grow w-full h-full overflow-hidden bg-gradient-to-br from-[#0078d4] to-[#c03bc4] rounded-2xl ${className ?? ""}`}
            style={style}
        >
